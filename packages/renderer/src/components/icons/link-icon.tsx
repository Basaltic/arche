...
export const LinkIconOutline = (props: { selected?: boolean }) => {
  ...
  return (
    <SvgIcon width="24" height="24" fill="none" viewBox="0 0 24 24" {...props}>
      ...
      ></path>
      <path stroke="#111827" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M14.25 9.75L9.75 14.25"></path>
    </SvgIcon>
  );
};
